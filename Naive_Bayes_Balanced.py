...
df_over.to_csv(f'data/Balancing/{file_tag}_train.csv', index=False)
train=df_over
...
plt.savefig('images/Balancing/balanced_distribution.png')
...
plt.tight_layout()
plt.savefig('images/balancing/diabetic_confusion_matrix.png')
...
plt.savefig(f'images/balancing/diabetic_mean_accuracy.png')
