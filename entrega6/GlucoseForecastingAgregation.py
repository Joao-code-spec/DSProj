...
index_col='Date'
target='Glucose'
data = read_csv('data/Glucose_forecasting_train.csv', index_col=index_col, sep=',', decimal='.', parse_dates=True,dayfirst=True, infer_datetime_format=True)
...
test = read_csv('data/Glucose_forecasting_test.csv', index_col=index_col, sep=',', decimal='.', parse_dates=True,dayfirst=True, infer_datetime_format=True)
train = data
...
plot_evaluation_results(train.values, prd_trn, test.values, prd_tst, f'images/glucose/forecastingRedone/{file_tag}_agregation_persistence_eval.png')
savefig(f'images/glucose/forecastingRedone/{nameOfData}_agregation_persistence_eval.png')
plot_forecasting_series(train, test, prd_trn, prd_tst, f'images/glucose/forecastingRedone/{file_tag}_agregation_persistence_plots.png', x_label=index_col, y_label=target)
savefig(f'images/glucose/forecastingRedone/{nameOfData}_agregation_persistence_plots.png')
