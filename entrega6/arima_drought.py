...
index='date'
target='QV2M'
data = read_csv('entrega6/data/drought.forecasting_dataset_DROP.csv', index_col=index, sep=',', decimal='.', parse_dates=True, infer_datetime_format=True, dayfirst=True)
data.index.freq = 'D'
...
savefig(f'entrega6/images/Drought/entrega7/{file_tag}_arima_study.png')
show()
...
savefig( f'entrega6/images/Drought/entrega7/{file_tag}_arima_eval.png')
...
savefig( f'entrega6/images/Drought/entrega7/{file_tag}_arima_plot.png')