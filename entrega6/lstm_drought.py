...
savefig(f'entrega6/images/drought/entrega7/{file_tag}_lstm_study.png')
...
plot_evaluation_results(trnY.data.numpy(), prd_trn, tstY.data.numpy(), prd_tst, f'entrega6/images/drought/entrega7/{file_tag}_lstm_eval.png')
savefig(f'entrega6/images/drought/entrega7/{file_tag}_lstm_eval.png')
plot_forecasting_series(trainY, testY, prd_trn.values, prd_tst.values, f'entrega6/images/drought/entrega7/{file_tag}_lstm_plots.png', x_label=index, y_label=target)
savefig(f'entrega6/images/drought/entrega7/{file_tag}_lstm_plots.png')