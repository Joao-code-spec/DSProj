...
plot_series(smooth_df, title=f'Smoothing (win_size={WIN_SIZE})', x_label='Date', y_label='Glucose')
xticks(rotation = 45)
savefig(f'images/glucose/forecastingRedone/{nameOfData}_smoothing' + str(WIN_SIZE) + '.png')
...
savefig(f'images/glucose/forecastingRedone/{file_name}')
